...
let testemonials = [
    {quote:'"Brooklyn Flower – Espalhando beleza e amor pétala por pétalas', origin:'cbs.svg' }, 
    {quote:'"Transforme seus momentos em flores inesquecíveis – Brooklyn Flower.',
        origin:'forbes.svg' }, 
    {quote:'"Brooklyn Flower: onde cada flor conta uma história.', origin:'fox.svg' }, 
    {quote:'"Flores que encantam, momentos que permanecem – Brooklyn Flower."',
